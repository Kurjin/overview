  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute top-3/4 left-1/2 w-64 h-64 bg-pink-500/5 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '4s' }} />
      </div>
            ...
            <div className={`transform transition-all duration-1000 ${
              ...
              <div className="space-y-8">
                ...
                <div className="space-y-4">
                  {contactInfo.map((contact, index) => {
                    ...
                    return (
                      ...
                      >
                        <div className={`w-14 h-14 bg-gradient-to-r ${contact.color} rounded-2xl flex items-center justify-center group-hover:scale-110 transition-transform duration-300 shadow-lg`}>
                          <IconComponent className="w-6 h-6 text-white" />
                        </div>
                        <div className="flex-1">
                          <p className="font-semibold text-white text-lg">{contact.label}</p>
                          <p className="text-blue-300 font-medium">{contact.value}</p>
                ...
                <div className={`transform transition-all duration-1000 ${
                  ...
                  <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-6 hover:border-purple-400/40 transition-all duration-300">
                    <div className="flex items-center mb-4">
                      ...
                      {socialLinks.map((social, index) => {
                        ...
                        return (
                          <a
                            ...
                            className={`group w-12 h-12 bg-white/10 rounded-2xl flex items-center justify-center transition-all duration-300 hover:scale-110 ${social.color} border border-white/20 hover:border-white/40`}
                          >
